...
import rajnish from "../assets/rajnish.png";
...
const projects: Project[] = [
  ...
  {
    id: 4,
    title: "Rajnis Kushwaha Youth Leadership",
    color: "#F59E0B",
    mockup: rajnish,
    link: "https://rajnish-alpha.vercel.app/",
    tags: ["YOUTH", "LEADERSHIP", "WEB APP"],
    description:
      "A platform for youth leadership development and engagement.",
    problem:
      "Youth needed a space to develop leadership skills and engage with peers.",
    architecture:
      "Built a web dashboard analyzing user data to generate customized leadership development plans.",
    metrics: [
      "Data-driven leadership plans",
              ...
              <div className="lg:w-3/5 p-8">
                ...
                {selectedProject.link && (
                  <a
                    ...
                    target="_blank"
                    className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-primary text-black rounded-lg font-semibold"
                  >
